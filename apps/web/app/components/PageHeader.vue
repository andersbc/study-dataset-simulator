<template>
  <div class="mb-4 mt-4 text-center text-md-left">
    <div class="d-flex flex-column flex-md-row align-center mb-10">
        ...
        <v-expand-transition @after-leave="isAlignedTop = false">
          <div v-if="showInfo" class="mt-4">
            <v-sheet class="pa-4 rounded bg-primary border text-subtitle-1 text-sm-h6 text-white text-left"
              ...
              <p class="mb-2">
                This tool helps you create realistic datasets without needing to collect actual data. You can use it
                for:
              </p>
              <ul class="ml-4 mb-2">
                <li><strong>Testing Analysis Pipelines:</strong> Perform analyses on datasets before you have your
                  real data.</li>
                <li><strong>Teaching & Learning:</strong> Demonstrate statistical concepts or practice analysis
                  techniques
                  safely.</li>
                <li><strong>Power Analysis:</strong> Explore how different effect sizes and sample sizes might look.
                </li>
              </ul>
              <p class="mt-2">
      ...
      <div class="flex-grow-0 d-flex flex-column align-end ml-4 gap-2">
        <v-btn to="/admin" variant="text" size="small" prepend-icon="mdi-shield-crown">
          Admin
        </v-btn>
    ...
    <!-- Page Title Row -->
    <div v-if="title" class="text-primary mb-2">
